...
function getName(info1) {
    for (const el of info1){
        console.log(el);
...
function getEmail(info2) {
    for (const el of info2){
...
if (document.querySelector(".container")) {
    ...
    document.addEventListener("keydown", (e)=>{
        if (e.code === "Enter") {
            ...
            const all_tasks2 = document.querySelectorAll(".delete");
            for(let i2 = 0; i2 < all_tasks2.length; i2++)all_tasks2[i2].addEventListener("click", function() {
    ...
    // delete list items
    const all_tasks1 = document.querySelectorAll(".delete");
    for(let i1 = 0; i1 < all_tasks1.length; i1++)all_tasks1[i1].addEventListener("click", function() {
        this.parentNode.remove();
        localStorage.setItem("list-items", document.querySelector(".to-do-list").innerHTML);
    });
    ...
    document.querySelector("#toggleTimer").addEventListener("click", ()=>{
        ...
        if (document.querySelector(".misc").hidden) document.querySelector(".misc").classList.add(".hide");
        else document.querySelector(".misc").classList.remove(".hide");
    });
    document.querySelector("#toggleMusic").addEventListener("click", ()=>{
        ...
        if (document.querySelector(".rightTop").hidden) document.querySelector(".rightTop").classList.add(".hide");
        else document.querySelector(".rightTop").classList.remove(".hide");
    });
    document.querySelector("#toggleCalendar").addEventListener("click", ()=>{
        ...
        if (document.querySelector(".rightBottom1").hidden) document.querySelector(".rightBottom1").classList.add(".hide");
        else document.querySelector(".rightBottom1").classList.remove(".hide");
    });
    document.querySelector("#toggleList").addEventListener("click", ()=>{
        ...
        if (document.querySelector(".rightBottom2").hidden) document.querySelector(".rightBottom2").classList.add(".hide");
        else document.querySelector(".rightBottom2").classList.remove(".hide");
    });
    function getTime() {
        let date = new Date();
...
//# sourceMappingURL=homepage.0a46cb63.js.map
